                                        ...
                                        <div class="card-body">
                                            ...
                                            <ol class="activity-feed">
                                                ...
                                                <li class="feed-item feed-item-info">
                                                    ...
                                                    <span class="text"> <a href="{{ route('bendahara.pengambilanSampel.detailOrder', $cp->id) }}" class="btn btn-xs btn-info shadow-sm my-1">
                                            ...
                                            <ol class="activity-feed">
                                                ...
                                                <li class="feed-item feed-item-info">
                                                    ...
                                                    <span class="text">Ada Mengirim Bukti Pembayaran
                                                        <a href="{{ route('bendahara.pengambilanSampel.showBuktiPembayaran', $pengambilan->id) }}" class="btn btn-primary btn-xs mb-2">Lihat Bukti Pembayaran</a>
                                                    </span>
                                                </li>
                                                @empty
                                                <p class="text-center">Tidak ada notifikasi</p>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ol class="activity-feed">
                                                ...
                                                <li class="feed-item feed-item-info">
                                                    ...
                                                    <span class="text">  <a href="{{ route('bendahara.pengujian.detailOrder', $cpu->id) }}" class="btn btn-xs btn-info shadow-sm my-1">
                                                        <i class="fas fa-pencil fa-sm text-white-50"></i>Detail order
                                                    </a>
                                                    <a href="{{ route('bendahara.pengujian.getOrder', $cpu->id) }}" class="btn btn-xs btn-primary shadow-sm my-1">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ol class="activity-feed">
                                                ...
                                                <li class="feed-item feed-item-info">
                                                    ...
                                                    <span class="text">Ada Mengirim Bukti Pembayaran
                                                        <a href="{{ route('bendahara.pengujian.showBuktiPembayaran', $pengujian->id) }}" class="btn btn-primary btn-xs mb-2">Lihat Bukti Pembayaran</a>
                                                    </span>
                                                </li>
                                                @empty
                                                <p class="text-center">Tidak ada notifikasi</p>
