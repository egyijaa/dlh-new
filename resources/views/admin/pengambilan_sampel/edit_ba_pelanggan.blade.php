...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <a href="{{ route('admin.pengambilanSampel.beritaAcara', $pengambilan->id) }}"><i class="fas fa-arrow-left"> Kembali</i></a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.pengambilanSampel.updateBaPelanggan', $pengambilan->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        ...
                        <a href="{{ route('admin.pengambilanSampel.cetakBaPelanggan', $pengambilan->id) }}" target="_blank"><i class="btn btn-sm btn-primary shadow-sm my-2">Lihat PDF BA Pelanggan</i></a> 
                        @endif
                    </div>
                </div>
            </div>
