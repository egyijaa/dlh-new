                            ...
                            <table id="basic-datatables" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('helper.pengambilanSampelSelesai.detailOrder', $p->id) }}" class="btn btn-xs btn-info shadow-sm my-1">
                                                <i class="fas fa-pencil fa-sm text-white-50"></i>Detail order
                                            </a>
                                            @if ($p->id_status_pengambilan_sampel >= 5)
                                            <a href="{{ route('helper.pengambilanSampelSelesai.beritaAcara', $p->id) }}" class="btn btn-xs btn-primary shadow-sm my-1">
