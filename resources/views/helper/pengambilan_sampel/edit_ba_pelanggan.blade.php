...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <a href="{{ route('helper.pengambilanSampel.beritaAcara', $pengambilan->id) }}"><i class="fas fa-arrow-left"> Kembali</i></a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('helper.pengambilanSampel.updateBaPelanggan', $pengambilan->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="foto_ba1">Upload Scan/Foto BA Lembar 1 <i><small>Jpg/Jpeg/PNG|Max: 3 Mb</small></i></label>
                            ...
                            <div class="form-group">
                                <label for="foto_ba2">Upload Scan/Foto BA Lembar 2 <i><small>Jpg/Jpeg/PNG|Max: 5 Mb</small></i></label>
                        ...
                        <a href="{{ route('helper.pengambilanSampel.cetakBaPelanggan', $pengambilan->id) }}" target="_blank"><i class="btn btn-sm btn-primary shadow-sm my-2">Lihat PDF BA Pelanggan</i></a> 
                        @endif
                    </div>
                </div>
            </div>
