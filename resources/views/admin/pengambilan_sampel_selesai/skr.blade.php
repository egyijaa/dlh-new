...
<head>
    ...
    <title>SKR | {{ $pengambilan_order->nomor_pre }}</title>
    <style>
        .calibri {
    ...
    <div class="calibri">
        ...
        <table style="width: 100%; font-size: 13px; padding-left: 25px; padding-right: 25px;">
            <tr>
                ...
                <td>: {{ $pengambilan_order->nama_pemesan }} </td>
            </tr>
            <tr>
                <td style="width: 30%">ALAMAT</td>
                <td>: {{ $pengambilan_order->alamat }}</td>
            </tr>
            <tr>
        ...
        <table
            ...
            <tr>
                <td style="border: 1px solid black;"></td>
                <td style="border: 1px solid black;"></td>
                <td style="border: 1px solid black;" align="center">{{ $pengambilan_order->sampelUji->nama_sampel }} (@currency($pengambilan_order->sampelUji->harga)) </td>
                ...
                <td style="border: 1px solid black;" align="center">@currency($pengambilan_order->total_harga)</td>
            </tr>
         
            <tr>
                <td style="border: 1px solid black;"></td>
                <td style="border: 1px solid black;" colspan="4" align="center">Jumlah Total</td>
                <td style="border: 1px solid black;" align="center"><b>@currency($pengambilan_order->total_harga)</b></td>
            </tr>
        </table>
        <br>
