...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <a href="{{ route('bendahara.pengujian.index') }}"><i class="fas fa-arrow-left"> Kembali</i></a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('bendahara.pengujian.updateBuktiPembayaran', $pengujian->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
