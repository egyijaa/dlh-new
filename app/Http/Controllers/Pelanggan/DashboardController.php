...
class DashboardController extends Controller
{
    public function index(){
        ...
        $timeline_pengambilan = TimelinePengambilanSampel::where('id_user', auth()->user()->id)->orderBy('id', 'DESC')->limit(10)->get();

        $timeline_pengujian = TimelinePengujian::where('id_user', auth()->user()->id)->orderBy('id', 'DESC')->limit(10)->get();
