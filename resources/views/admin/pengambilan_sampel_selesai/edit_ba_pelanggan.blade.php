...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <a href="{{ route('admin.pengambilanSampelSelesai.beritaAcara', $pengambilan->id) }}"><i class="fas fa-arrow-left"> Kembali</i></a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.pengambilanSampelSelesai.updateBaPelanggan', $pengambilan->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
