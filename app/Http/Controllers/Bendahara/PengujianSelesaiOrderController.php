...
class PengujianSelesaiOrderController extends Controller
{
    public function index(){
        ...
        return view('bendahara.pengujian_selesai_order.index', compact('pengujian', 'status'));
    }
    ...
    public function getOrder(Request $request, $id){
        ...
        return view('bendahara.pengujian_selesai_order.cek_sampel', compact('id_pengujian_order', 'nomor_pre', 'status', 'sampel_order'));
    }
    ...
    public function detailOrder($id){
        ...
        return view('bendahara.pengujian_selesai_order.detail_order', compact('id_pengujian_order', 'pengujian_order'));
    }
    ...
    public function cetakInvoice($id){
        ...
        $pdf = PDF::loadview('bendahara.pengujian_selesai_order.invoice', compact('pengujian_order', 'tanggal_buat'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
    ...
    public function cetakSkr($id){
        ...
        $pdf = PDF::loadview('bendahara.pengujian_selesai_order.skr', compact('pengujian_order', 'skr', 'tanggal_skr', 'kadis'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
    ...
    public function cetakTbp($id){
        ...
        $pdf = PDF::loadview('bendahara.pengujian_selesai_order.tbp', compact('pengujian_order', 'tbp', 'no_skr', 'bendahara'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }

    public function showBuktiPembayaran($id){
        $pengujian = PengujianOrder::findOrFail($id);
        return view('bendahara.pengujian_selesai_order.bukti_pembayaran', compact('pengujian'));
    }
