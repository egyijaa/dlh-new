...
class PengambilanSampelSelesaiController extends Controller
{
    public function index(){
        ...
        return view('bendahara.pengambilan_sampel_selesai.index', compact('pengambilan', 'status'));
    }
    ...
    public function detailOrder($id){
        ...
        return view('bendahara.pengambilan_sampel_selesai.detail_order', compact('id_pengambilan_sampel_order', 'pengambilan'));
    }
    ...
    public function cetakInvoice($id){
        ...
        $pdf = PDF::loadview('bendahara.pengambilan_sampel_selesai.invoice', compact('pengambilan_order', 'tanggal_buat'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
    ...
    public function cetakSkr($id){
        ...
        $pdf = PDF::loadview('bendahara.pengambilan_sampel_selesai.skr', compact('pengambilan_order', 'skr', 'tanggal_skr', 'kadis'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
    ...
    public function cetakTbp($id){
        ...
        $pdf = PDF::loadview('bendahara.pengambilan_sampel_selesai.tbp', compact('pengambilan_order', 'tbp', 'no_skr', 'bendahara'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }

    public function showBuktiPembayaran($id){
        $pengambilan = PengambilanSampelOrder::findOrFail($id);
        return view('bendahara.pengambilan_sampel_selesai.bukti_pembayaran', compact('pengambilan'));
    }
