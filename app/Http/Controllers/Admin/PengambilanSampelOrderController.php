...
class PengambilanSampelOrderController extends Controller
{
    ...
    public function cetakSkr($id){
        ...
        $pdf = PDF::loadview('admin.pengambilan_sampel.skr', compact('pengambilan_order', 'skr', 'tanggal_skr', 'kadis'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
    ...
    public function cetakTbp($id){
        ...
        $pdf = PDF::loadview('admin.pengambilan_sampel.tbp', compact('pengambilan_order', 'tbp', 'no_skr', 'bendahara'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
    ...
    public function cetakBa($id){
        ...
        $pdf = PDF::loadview('admin.pengambilan_sampel.ba', compact('pengambilan_order', 'berita_acara', 'teknis', 'penyelia'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
