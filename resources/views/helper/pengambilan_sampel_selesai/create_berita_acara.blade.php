...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <a href="{{ route('helper.pengambilanSampelSelesai.index') }}"><i class="fas fa-arrow-left"> Kembali</i></a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header justify-content-between d-flex d-inline">
                        <h4 class="card-title">Pembuatan Berita Acara {{ $pengambilan->nomor_pre }}</h4>
                    </div>
                    <div class="card-body">
                        @php
                        ...
                        <form action="{{ route('helper.pengambilanSampelSelesai.storeBeritaAcara') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                @for ($i = 1; $i <= $titik; $i++)
