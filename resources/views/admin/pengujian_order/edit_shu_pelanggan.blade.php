...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <a href="{{ route('admin.pengujian.getOrder', $sampel->pengujianOrder->id) }}"><i class="fas fa-arrow-left"> Kembali</i></a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.pengujian.updateShuPelanggan', $sampel->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        ...
                        <a href="{{ route('admin.pengujian.cetakShuPelanggan', $sampel->id) }}" target="_blank"><i class="btn btn-sm btn-primary shadow-sm my-2">Lihat PDF SHU Pelanggan</i></a> 
                        @endif
                    </div>
                </div>
            </div>
