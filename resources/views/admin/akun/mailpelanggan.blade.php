            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Akun Berhasil Diverifikasi</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                                Selamat! Akun anda berhasil Diverifikasi di website PONTIANAK LABORATORY INFORMATION SYSTEM (POLIS), Silahkan kunjungi link <a href="http://127.0.0.1:8000/pelanggan/dashboard">Dashboard</a> untuk mengakses halaman dashboard dengan login menggunakan email serta password berdasarkan register sebelumnya. Jika lupa dengan email dan password bisa langsung hubungi admin.
                              </td>
                          </tr>
                        </table>
                        <div>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>TerimaKasih</p>
                              <p>Email ini dikirimkan secara otomatis oleh sistem, kami tidak melakukan pengecakan email yang dikirimkan ke email ini. Jika ada pertanyaan, silahkan kunjungi website kami untuk lebih jelasnya</p>
                            </td>
                          </tr>
                        </table>
                      </td>
