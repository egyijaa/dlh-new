...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <a href="{{ route('admin.pengujian.getOrder', $id_pengujian_order) }}"><i class="fas fa-arrow-left"> Kembali</i></a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="basic-datatables" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-id="{{ $p->id }}" data-parameter="{{ $p->parameterSampel->nama_parameter }}" data-metode="{{ $p->metode_uji }}" data-satuan="{{ $p->satuan }}" data-baku="{{ $p->baku_mutu }}" data-hasil="{{ $p->hasil_pengujian }}" data-toggle="modal" data-target="#edit"><i class="fas fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.pengujian.updateHasil') }}" method="POST">
                @csrf
                @method('PUT')
