    ...
    <div class="calibri">
        ...
        <table style="width: 100%; font-size: 13px; padding-left: 25px; padding-right: 25px;">
            ...
            <tr>
                ...
                <td>: {{  $pengambilan_order->created_at->add('3 day')->format('d M Y') }} </td>
            </tr>
        </table>
        <br>
        <table
            ...
            <tr>
                ...
                <td style="border: 1px solid black;" align="left" colspan="2">
                     ...
                     x {{ $pengambilan_order->jumlah_titik_sampling }} titik
                    
                </td>
                <td style="border: 1px solid black;" align="right">@currency($pengambilan_order->total_harga)</td>
            </tr>
