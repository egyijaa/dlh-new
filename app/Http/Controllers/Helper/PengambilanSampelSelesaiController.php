...
class PengambilanSampelSelesaiController extends Controller
{
    public function index(){
        ...
        return view('helper.pengambilan_sampel_selesai.index', compact('pengambilan', 'status'));
    }
    ...
    public function detailOrder($id){
        ...
        return view('helper.pengambilan_sampel_selesai.detail_order', compact('id_pengambilan_sampel_order', 'pengambilan'));
    }
    ...
    public function beritaAcara($id){
        ...
        return view('helper.pengambilan_sampel_selesai.edit_berita_acara', compact('pengambilan', 'berita_acara'));
        } else {
        $pengambilan = PengambilanSampelOrder::findOrFail($id);
        return view('helper.pengambilan_sampel_selesai.create_berita_acara', compact('pengambilan'));
        }     
    }
    ...
    public function storeBeritaAcara(Request $request){
        ...
        try {
            ...
            return redirect()->route('helper.pengambilanSampelSelesai.index');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function cetakBa($id){
        ...
        $pdf = PDF::loadview('helper.pengambilan_sampel_selesai.ba', compact('pengambilan_order', 'berita_acara', 'teknis', 'penyelia'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }

    public function editBaPelanggan($id){
        $pengambilan = PengambilanSampelOrder::findOrFail($id);
        return view('helper.pengambilan_sampel_selesai.edit_ba_pelanggan', compact('pengambilan'));
    }
    ...
    public function cetakBaPelanggan($id){
        ...
        $pdf = PDF::loadview('helper.pengambilan_sampel_selesai.ba_pelanggan', compact('pengambilan'))->setPaper('a4', 'potrait');
	    return $pdf->stream();
    }
}
