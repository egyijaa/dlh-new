...
<head>
    ...
    <title>TBP | {{ $pengambilan_order->nomor_pre }}</title>
    <style>
        body {
    ...
    <div class="div">
        ...
        <table style="width: 100%; font-size: 14px; padding-left: 27px; font-size: 11.5px">
            ...
            <tr>
                ...
                <td colspan="2" style="width: 96%"> <span style="padding-right: 50px">Telah menerima uang sebesar
                        </span><span style="border: 1px solid black; padding: 2 2 2 40;">@currency($pengambilan_order->total_harga)</span></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="2" style="width: 96%">(<i> @php
                  echo terbilang($pengambilan_order->total_harga);
              @endphp RUPIAH</i>)</td>
            </tr>
            <tr>
                <td>b. </td>
                <td style="width: 20%">Dari Nama</td>
                <td style="width: 76%">: {{ $pengambilan_order->nama_pemesan }}</td>
            </tr>
            <tr>
                <td>c. </td>
                <td style="width: 20%">Alamat</td>
                <td style="width: 76%">: {{ $pengambilan_order->alamat }}</td>
            </tr>
            <tr>
        ...
        <table style="border-collapse: collapse; width: 100%; font-size: 14px; padding-left: 195px; padding-right: 15px; font-size: 11.5px; border: 1px solid black">
            ...
            <tr>
                ...
                <td align="right" style="border: 1px solid black; width:22%">@currency($pengambilan_order->total_harga)</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="right" style="border: 1px solid black">@currency($pengambilan_order->total_harga)</td>
            </tr>
        </table>
        <table style="width: 100%; font-size: 14px; padding-left: 27px; font-size: 11.5px">
            <tr>
                ...
                <td style="width: 76%">: {{ date('d M Y', strtotime($pengambilan_order->tanggal_bayar)) }}</td>
            </tr>
            <tr>
                <td>f. </td>
