...
<div class="content">
    <div class="page-inner">
        <div class="page-header justify-content-between d-flex d-inline">
            ...
            <a href="{{ route('admin.pengambilanSampel.editBaPelanggan', $pengambilan->id) }}" class="btn btn-info btn-sm mb-1">Upload BA Pelanggan</a>
            @endif
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header justify-content-between d-flex d-inline">
                        ...
                        <a href="{{ route('admin.pengambilanSampel.cetakBa', $pengambilan->id) }}" target="_blank"><i class="btn btn-sm btn-primary my-1 shadow-sm">Cetak PDF BA</i></a>
                    </div>
                    <div class="card-body">
                        @php
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.pengambilanSampel.updateBeritaAcara') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
