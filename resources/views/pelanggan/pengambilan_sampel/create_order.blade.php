        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('pelanggan.pengambilanSampel.storeOrder') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @endphp
                                        <input type="date" readonly value="{{ $now }}"
                                            class="form-control @error('tanggal_isi') is-invalid @enderror"
                                            id="tanggal_isi" name="tanggal_isi">
                                        @error('tanggal_isi')
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="id_tipe_pelanggan" id="id_tipe_pelanggan"
                                            class="custom-select @error('id_tipe_pelanggan') is-invalid @enderror"
                                            required>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('no_hp') is-invalid @enderror"
                                            id="no_hp" name="no_hp" required placeholder="081423xxxxxx">
                                        @error('no_hp')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" class="form-control" id="alamat" cols="5" rows="5"
                                            required></textarea>
                                        @error('alamat')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup w-100 col-9">
                                            <label class="selectgroup-item">
                                                <input value="Dalam Kota Pontianak" type="radio" name="jasa_pelayanan" id="jasa_pelayanan" class="selectgroup-input" checked>
                                                <span class="selectgroup-button">Dalam Kota Pontianak</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input value="Luar Kota Pontianak" type="radio" name="jasa_pelayanan" id="jasa_pelayanan" class="selectgroup-input">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group border border-color-dark mt-2">
                                        ...
                                        <span style="font-size: 120%" id="harga"
                                            class="badge badge-primary text-bold"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="selectgroup selectgroup-pills">
                                            @foreach ($sampel as $item)
                                                    ...
                                                    @else
                                                        @if ($item->status != 0)
                                                        <label class="selectgroup-item">
                                                            <input type="radio" class="hargaSampel selectgroup-input" name="jenis_sampel" id="jenis_sampels" data-harga="{{ $item->harga }}" value="{{ $item->id }}">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            ...
                                            id="tanggal_sampling" name="tanggal_sampling" required>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="alamat_sampling"><b>Lokasi Pengambilan Sampel* <i><small>(diisi dengan
                                                        lengkap)</small></i></b></label>
                                        <textarea name="alamat_sampling" class="form-control" id="alamat_sampling" cols="5"
                                            rows="5" required
                                            placeholder="cth : Jln. Nusa Indah, gg. merak,  di depan warung bu aci no. 20"></textarea>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="pendamping_sampling" class="form-control" id="pendamping_sampling"
                                            cols="5" rows="5" required placeholder="cth : Pak Fulan, Hp: 0813xxxxxxxx"></textarea>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="jumlah_lokasi_sampling" name="jumlah_lokasi_sampling" required>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="form-group">
                                        <label class="form-label" for="volume_sampel">Volume Sampel*</label>
                                            ...
                                            @foreach ($volume as $v)
                                                <label class="selectgroup-item">
                                                    <input type="radio" name="volume_sampel" id="volume_sampel" class="selectgroup-input" value="{{ $v->id }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <li>Pelanggan memastikan lokasi sampling dapat diakses dan aman bagi petugas
                                            pengambil sampel uji</li>
                                        <li>Jika saat pengambilan sampel ternyata volume sampel tidak terwakilkan maka
                                            pengambilan sampel tidak dapat dilakukan dan biaya sampling tidak dapat
                                            dikembalikan</li>
                                        <li>Jika pengambilan sampel membutuhkan wadah khusus sampel (botol kaca/ wadah
                                            gelap), maka wadah tersebut disediakan oleh pelanggan.</li>
                                        <li>Transportasi dan akomodasi sampling di luar Kota Pontianak ditanggung oleh
                                            pengguna jasa</li>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" name="konfirmasi" id="konfirmasi" required> &nbsp;<label
                                    for="konfirmasi">Saya Setuju Dengan Persyaratan diatas</label>
                            </div>
