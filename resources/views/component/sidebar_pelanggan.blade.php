    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-primary">
                ...
                <li class="nav-item {{ request()->is('pelanggan/sampel-uji') || request()->is('pelanggan/pengujian')|| request()->is('pelanggan/pengujian/getOrder/*') || request()->is('pelanggan/pengujian/detailOrder/*') || request()->is('pelanggan/pengujian/tracking/*') || request()->is('pelanggan/pengujian/updateSampelParameter/*') || request()->is('pelanggan/pengujian/editSampelParameter/*') || request()->is('pelanggan/pengujian/createSampel/*') || request()->is('pelanggan/pengujian/showInvoice/*') || request()->is('pelanggan/pengambilanSampel') || request()->is('pelanggan/pengambilanSampel/createOrder') || request()->is('pelanggan/pengambilanSampel/detailOrder/*') || request()->is('pelanggan/pengambilanSampel/showInvoice/*') || request()->is('pelanggan/pengambilanSampel/tracking/*') ? 'active' : '' }} submenu">
                    <a data-toggle="collapse" href="#orderbaru" class="collapsed" aria-expanded="false">
                        <i class="fas fa-clipboard-list"></i>
                        <p>Order Baru</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse {{ request()->is('pelanggan/sampel-uji') || request()->is('pelanggan/pengujian') || request()->is('pelanggan/pengujian/getOrder/*') || request()->is('pelanggan/pengujian/detailOrder/*') || request()->is('pelanggan/pengujian/tracking/*') || request()->is('pelanggan/pengujian/updateSampelParameter/*') || request()->is('pelanggan/pengujian/editSampelParameter/*') || request()->is('pelanggan/pengujian/createSampel/*') || request()->is('pelanggan/pengujian/showInvoice/*') || request()->is('pelanggan/pengambilanSampel') || request()->is('pelanggan/pengambilanSampel/createOrder') || request()->is('pelanggan/pengambilanSampel/detailOrder/*') || request()->is('pelanggan/pengambilanSampel/showInvoice/*') || request()->is('pelanggan/pengambilanSampel/tracking/*') ?'show' : '' }}" id="orderbaru">
                        <ul class="nav nav-collapse">
                            <li class="{{ request()->is('pelanggan/pengambilanSampel') || request()->is('pelanggan/pengambilanSampel/createOrder') || request()->is('pelanggan/pengambilanSampel/detailOrder/*') || request()->is('pelanggan/pengambilanSampel/showInvoice/*') || request()->is('pelanggan/pengambilanSampel/tracking/*') ?'active' : '' }}">
